...
define config.name = _("NetPro: Magang Jaringan")
...
define gui.about = _p("""
NetPro: Magang Jaringan adalah game edukasi Visual Novel
bertema Teknik Komputer dan Jaringan (TKJ).

Jelajahi dunia IT sebagai teknisi magang dan pelajari:
• Jenis kabel UTP & standar crimping T568B
• OSI Model dan troubleshooting jaringan
• Analisis broadcast storm & Spanning Tree Protocol

Versi 1.0 | Dikembangkan dengan Ren'Py
""")
...
define build.name = "NetProMagangJaringan"
...
define config.save_directory = "Renpy1-1775223875"
